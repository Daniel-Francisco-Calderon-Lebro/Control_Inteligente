...
data = np.loadtxt(r'Red Neuronal Identificación\Probador_red_MLP\data_normalizada_prueba.txt', delimiter=',', skiprows=1)
...
filename='vectores_desplazados_prueba.txt'
