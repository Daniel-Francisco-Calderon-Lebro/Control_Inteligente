...
sys = cl.tf(num, den)      # FT Planta
feeed = cl.feedback(sys,1) # lazo cerrdado de la planta           
...
for i in S:
    print(f"{i}: {S[i]}") # imprimir la informacion del step de la plnata 
...
plt.legend(['Control P','lazo abiero','lazo cerrado'], loc="lower right")
